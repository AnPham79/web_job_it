<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0 text-center"
            ...
            <i class="fa-solid fa-business-time text-white fs-5"></i>
            <span class="ms-1 font-weight-bold text-white">JOBVIP</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{ route('employee.employee-index-manager') }}">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{ route('posts.posts-index-manager') }}">
